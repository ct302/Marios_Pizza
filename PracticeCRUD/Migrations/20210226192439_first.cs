        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WingsName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WingsCount = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    FinalItemPrice = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkToUserTableID = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TimeRegistered = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Item_Price = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    orderPriceTotal = table.Column<double>(type: "float", nullable: false),
                    timeOrdered = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_newCustomerOrders", x => x.OrderID);
                });
